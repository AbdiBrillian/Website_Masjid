...
<head>
  ...
  <title>Masjid Istiqlal - Kas</title>
  <!-- Favicon -->
      ...
      <div class="container">
        <div class="header-body text-center mb-7">
          <div class="row justify-content-center">
            ...
            <img alt="Image placeholder" src="{{asset('argon/assets/img/theme/masjid.jpg')}} " width="100px">
       
              <h1 class="text-white">Masjid Istiqlal</h1>
              <p class="text-lead text-light"><i><b>“Tetapi, 
               jika sebagian kamu mempercayai sebagian yang lain, 
               hendaklah yang dipercayai itu menunaikan amanatnya (utangnya) dan hendaklah dia bertakwa kepada Allah, 
               Tuhan-nya. Dan janganlah kamu menyembunyikan kesaksian, karena barangsiapa menyembunyikannya, sungguh,
                hatinya kotor (berdosa). Allah Maha Mengetahui apa yang kamu kerjakan - Al Baqarah ayat 283”</b></i></p>
            </div>
          </div>
        </div>
      </div>
          ...
          <div class="card bg-secondary shadow border-0">
            ...
            <div class="card-body px-lg-5 py-lg-5">
              ...
              <form role="form" method="POST" action="{{ route('login') }}">
                ...
                <button  class="btn btn-primary my-4"><a style="color:white" href="{{ url('index') }}">Back</a></button>
                </div>
              </form>
